...
<title>HDFC Bank</title>
   ...
   <link href="images/HDFC-Bank.png" rel="icon">
   <link href="images/HDFC-Bank.png" rel="apple-touch-icon">
...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/HDFC-Bank.png" width="45" alt="" class="logo-img"><b>HDFC Bank</b></a>
 ...
 <?php echo $userData['name']; ?> <b class="caret"></b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
         ...
         <image class="postcard__img" src="images/HDFC-Bank.png" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to HDFC Bank</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>HDFC Bank</b> is the biggest commercial bank in india . It is a private sector bank and has its headquarters in mumbai.</div>
        <p><span class="lv">Latest Notification :</span></p>
<style> 
.lv{
  font-weight: 600;
  color: #eb0202;
